...
draw_set_halign(1)
draw_text(global.width/2,global.height-52,"["+key_get_name(key_menu)+"] "+lang("menuaccept"))
draw_set_halign(2)
draw_text(global.width-34,global.height-52,"["+key_get_name(key_jump)+"] "+lang("menuoptions"))
draw_set_halign(0)
